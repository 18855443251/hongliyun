! function () {
  var e, t = function (e) {
    ...
    function h(e, n, r) {
      ...
      if (void 0 === r && 1 === e.nodeType)
        if (i = "data-" + n.replace(Ee, "-$&").toLowerCase(), r = e.getAttribute(i), "string" == typeof r) {
          try {
            r = p(r)
          } catch (o) {
            t(o)
    ...
    function b(e, t, n, r, i) {
      for (var o, a, s, l, u, c, d = t.createDocumentFragment(), f = [], p = 0, h = e.length; p < h; p++)
        if (o = e[p], o || 0 === o)
          if ("object" === ne.type(o)) ne.merge(f, o.nodeType ? [o] : o);
          else if (Fe.test(o)) {
      ...
      for (d.textContent = "", p = 0; o = f[p++];)
        ...
        else if (u = ne.contains(o.ownerDocument, o), a = y(d.appendChild(o), "script"), u && x(a), n)
    ...
    function A(e, t) {
      ...
      if (1 === t.nodeType) {
        if (ke.hasData(e) && (o = ke.access(e), a = ke.set(t, o), u = o.events)) {
          ...
          for (i in u)
            for (n = 0, r = u[i].length; n < r; n++) ne.event.add(t, i, u[i][n])
        }
    ...
    function N(e, t, r, i) {
      ...
      if (f && (o = b(t, e[0].ownerDocument, !1, e, i), a = o.firstChild, 1 === o.childNodes.length && (o = a), a || i)) {
        ...
        if (l)
          for (c = s[s.length - 1].ownerDocument, ne.map(s, D), d = 0; d < l; d++) u = s[d], Ie.test(u.type || "") && !ke.access(u, "globalEval") && ne.contains(c, u) && (u.src ? ne._evalUrl && ne._evalUrl(u.src) : n(u.textContent.replace(Ve, ""), c))
      }
      return e
    }
    ...
    ne.fn = ne.prototype = {
      ...
      var e, t, n, r, i, o, a = arguments[0] || {},
        ...
        l = arguments.length,
        u = !1;
      for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || ne.isFunction(a) || (a = {}), s === l && (a = this, s--); s < l; s++)
        if (null != (e = arguments[s]))
          for (t in e) n = a[t], r = e[t], a !== r && (u && r && (ne.isPlainObject(r) || (i = Array.isArray(r))) ? (i ? (i = !1, o = n && Array.isArray(n) ? n : []) : o = n && ne.isPlainObject(n) ? n : {}, a[t] = ne.extend(u, o, r)) : void 0 !== r && (a[t] = r));
      return a
    }, ne.extend({
    ...
    var se = function (e) {
      ...
      function g(e, t, n) {
        ...
        return t.first ? function (t, n, i) {
          ...
          if (l) {
            ...
            for (; t = t[r];)
              if (1 === t.nodeType || a)
                if (d = t[q] || (t[q] = {}), c = d[t.uniqueID] || (d[t.uniqueID] = {}), i && i === t.nodeName.toLowerCase()) t = t[r] || t;
                else {
      ...
      function x(e, t, n, r, o, a) {
        return r && !r[q] && (r = x(r)), o && !o[q] && (o = x(o, a)), i(function (i, a, s, l) {
          var u, c, d, f = [],
            ...
            x = n ? o || (i ? e : h || r) ? [] : a : v;
          if (n && n(v, x, s, l), r)
            for (u = y(x, p), r(u, [], s, l), c = u.length; c--;)(d = u[c]) && (x[p[c]] = !(v[p[c]] = d));
          if (i) {
            if (o || e) {
              if (o) {
        ...
        for (var t, n, r, i = e.length, o = C.relative[e[0].type], a = o || C.relative[" "], s = o ? 1 : 0, l = g(function (e) {
          ...
          if (n = C.relative[e[s].type]) c = [g(v(c), n)];
            ...
            if (n = C.filter[e[s].type].apply(null, e[s].matches), n[q]) {
              ...
              return x(s > 1 && v(c), s > 1 && h(e.slice(0, s - 1).concat({
                value: " " === e[s - 2].type ? "*" : ""
              })).replace(le, "$1"), n, s < r && b(e.slice(s, r)), r < i && b(e = e.slice(r)), r < i && h(e))
            }
            c.push(n)
          } return v(c)
      }
        ...
        var r = t.length > 0,
          ...
          a = function (i, a, s, l, u) {
            ...
            for (u && (N = a === M || a || u); h !== w && null != (c = x[h]); h++) {
              if (o && c) {
                for (d = 0, a || c.ownerDocument === M || (B(c), s = !H); f = e[d++];)
                  if (f(c, a || M, s)) {
                    l.push(c);
                    break
                  } u && (z = b)
      ...
      var _, k, C, T, E, D, A, L, N, S, P, B, M, I, H, F, O, R, j, q = "sizzle" + 1 * new Date,
        U = e.document,
        z = 0,
        W = 0,
        $ = r(),
      ...
      k = n.support = {}, E = n.isXML = function (e) {
            ...
            return 1 === r && 0 === i ? function (e) {
              ...
              if (v) {
                ...
                if (h = [a ? v.firstChild : v.lastChild], a && y) {
                  for (f = v, d = f[q] || (f[q] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), u = c[e] || [], p = u[0] === z && u[1], x = p && u[2], f = p && v.childNodes[p]; f = ++p && f && f[g] || (x = p = 0) || h.pop();)
                    if (1 === f.nodeType && ++x && f === t) {
                      c[e] = [z, p, x];
                      break
                    }
                } else if (y && (f = t, d = f[q] || (f[q] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), u = c[e] || [], p = u[0] === z && u[1], x = p), x === !1)
                  for (;
                    (f = ++p && f && f[g] || (x = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== m : 1 !== f.nodeType) || !++x || (y && (d = f[q] || (f[q] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), c[e] = [z, x]), f !== t)););
        ...
        pseudos: {
          ...
          lang: i(function (e) {
            return pe.test(e || "") || n.error("unsupported lang: " + e), e = e.replace(be, we).toLowerCase(),
              function (t) {
                var n;
                do
      ...
      return p.prototype = C.filters = C.pseudos, C.setFilters = new p, D = n.tokenize = function (e, t) {
        ...
        if (n = n || [], 1 === c.length) {
          ...
          for (i = he.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !C.relative[s = a.type]);)
            if ((l = C.find[s]) && (r = l(a.matches[0].replace(be, we), xe.test(o[0].type) && f(t.parentNode) || t))) {
    ...
    var pe, he = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,
      ge = ne.fn.init = function (e, t, n) {
        ...
        if (n = n || pe, "string" == typeof e) {
          ...
          if (r[1]) {
            if (t = t instanceof ne ? t[0] : t, ne.merge(this, ne.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : z, !0)), de.test(r[1]) && ne.isPlainObject(t))
        ...
        c = {
          ...
          remove: function () {
            return ne.each(arguments, function (e, t) {
              for (var n;
                (n = ne.inArray(t, o, n)) > -1;) o.splice(n, 1), n <= l && l--
            }), this
          },
          has: function (e) {
    ...
    ne.event = {
      ...
      add: function (e, t, n, r, i) {
        ...
        if (v)
          for (n.handler && (o = n, n = o.handler, i = o.selector), i && ne.find.matchesSelector(Oe, i), n.guid || (n.guid = ne.guid++), (l = v.events) || (l = v.events = {}), (a = v.handle) || (a = v.handle = function (t) {
        ...
        if (v && (l = v.events)) {
          for (t = (t || "").match(ye) || [""], u = t.length; u--;)
            if (s = qe.exec(t[u]) || [], p = g = s[1], h = (s[2] || "").split(".").sort(), p) {
              ...
              for (p in l) ne.event.remove(e, p + t[u], n, r, !0);
      ...
      dispatch: function (e) {
        ...
        if (s.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, s) !== !1) {
          for (a = ne.event.handlers.call(this, s, u), t = 0;
            (i = a[t++]) && !s.isPropagationStopped();)
            for (s.currentTarget = i.elem, n = 0;
              (o = i.handlers[n++]) && !s.isImmediatePropagationStopped();) s.rnamespace && !s.rnamespace.test(o.namespace) || (s.handleObj = o, s.data = o.data, r = ((ne.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, l), void 0 !== r && (s.result = r) === !1 && (s.preventDefault(), s.stopPropagation()));
    ...
    ne.extend({
      ...
      clone: function (e, t, n) {
        ...
        if (!(ee.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ne.isXMLDoc(e)))
          for (a = y(s), o = y(e), r = 0, i = o.length; r < i; r++) L(o[r], a[r]);
        if (t)
          if (n)
            for (o = o || y(e), a = a || y(s), r = 0, i = o.length; r < i; r++) A(o[r], a[r]);
          else A(e, s);
    ...
    ne.extend({
      ...
      ne.cssHooks[t] = {
        ...
        set: function (e, n, r) {
          var i, o = r && Ye(e),
            a = r && F(e, t, r, "border-box" === ne.css(e, "boxSizing", !1, o), o);
      ...
      if (t) return (parseFloat(P(e, "marginLeft")) || e.getBoundingClientRect().left - Se(e, {
        marginLeft: 0
      }, function () {
    ...
    ne.fn.extend({
      ...
      toggleClass: function (e, t) {
        ...
        return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : ne.isFunction(e) ? this.each(function (n) {
          ...
          var t, r, i, o;
          if ("string" === n)
            for (r = 0, i = ne(this), o = e.match(ye) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
          else void 0 !== e && "boolean" !== n || (t = j(this), t && ke.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : ke.get(this, "__className__") || ""))
        })
      },
      hasClass: function (e) {
        var t, n, r = 0;
        for (t = " " + e + " "; n = this[r++];)
          if (1 === n.nodeType && (" " + R(j(n)) + " ").indexOf(t) > -1) return !0;
        return !1
      }
    });
    var at = /\r/g;
    ...
    ne.extend(ne.event, {
      trigger: function (t, n, r, i) {
        ...
        if (a = s = r = r || z, 3 !== r.nodeType && 8 !== r.nodeType && !st.test(p + ne.event.triggered) && (p.indexOf(".") > -1 && (h = p.split("."), p = h.shift(), h.sort()), u = p.indexOf(":") < 0 && "on" + p, t = t[ne.expando] ? t : new ne.Event(p, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : ne.makeArray(n, [t]), d = ne.event.special[p] || {}, i || !d.trigger || d.trigger.apply(r, n) !== !1)) {
          ...
          for (o = 0;
            (a = f[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? l : d.bindType || p, c = (ke.get(a, "events") || {})[t.type] && ke.get(a, "handle"), c && c.apply(a, n), c = u && a[u], c && c.apply && _e(a) && (t.result = c.apply(a, n), t.result === !1 && t.preventDefault());
    ...
    return ne.param = function (e, t) {
      ...
      setOffset: function (e, t, n) {
        var r, i, o, a, s, l, u, c = ne.css(e, "position"),
          d = ne(e),
          f = {};
  ...
  ! function () {
    ...
    t.prototype = {
      ...
      for (var y = new Array(m), x = 0, d = 0; d < i; d++)
        for (var l = 0; l < t.length; l++) d < a[l].length && (y[x++] = a[l][d]);
      for (var d = 0; d < o; d++)
        for (var l = 0; l < t.length; l++) d < s[l].length && (y[x++] = s[l][d]);
      return y
    };
    for (var c = {
      MODE_NUMBER: 1,
    ...
    r.prototype = {
      ...
      multiply: function (e) {
        for (var t = new Array(this.getLength() + e.getLength() - 1), n = 0; n < this.getLength(); n++)
          for (var i = 0; i < e.getLength(); i++) t[n + i] ^= h.gexp(h.glog(this.get(n)) + h.glog(e.get(i)));
        return new r(t, 0)
      },
      mod: function (e) {
  ...
  var n = null,
    ...
    i = {
      ...
      setHeatState: function (e, t, n, i) {
        if (i) "1" === t ? this.setClickMap(e, n) : "2" === t ? this.setScrollMap(e, n) : "3" === t && this.setNoticeMap(e, n);
        else {
      ...
      setScrollMap: function (e, i) {
        ...
        if ("string" == typeof e && n.para.web_url) {
          ...
          s._values.Path = "/api/scroll_heat_map/report/" + e, s.addQueryString({
            pathUrl: encodeURIComponent(i)
          });
          var l = s.getUrl();
          r.ajax({
            url: i ? l : a.getUrl(),
            ...
            success: function (e) {
              ...
              if ("object" != typeof e || !r.isArray(e.result) || 0 === e.result.length) return o.showErrorInfo(2, {
                error: "\u672a\u53d6\u5230\u6570\u636e"
              }), !1;
              if (e.detail = e.result || [], 0 === e.result.length) return !1;
              if (!e.total || 0 === e.total || "number" != typeof e.total || e.total < 2) return o.showErrorInfo(2, {
                error: "\u6709\u6548\u7684\u89e6\u53d1\u7528\u6237\u6570\u5c11\u4e8e2\u4eba"
              }), !1;
            ...
            error: function (e) {
              r.isObject(e) && e.error ? o.showErrorInfo(2, {
                error: e.error
              }) : o.showErrorInfo(2, {
                error: "\u670d\u52a1\u5f02\u5e38"
      ...
      setToolbar: function (n, r, o) {
        ...
        p += '<div style="height: 45px; text-align: center; line-height: 45px; font-size:14px; font-family:PingFangSC-Medium,PingFang SC; font-weight:500; color:rgba(32,45,61,1); border-bottom: 1px solid #E9F0F7;">', p += "\u7b5b\u9009\u5c55\u793a\u5143\u7d20", p += "</div>", p += '<div style="height: 78px; border-bottom: 1px solid #E9F0F7;">', p += '<p style="margin: 0; line-height: 78px; padding-left: 20px; font-size:14px; font-family:PingFangSC-Regular,PingFang SC; font-weight:400; color:rgba(71,86,105,1);">\u70b9\u51fb\u6570 <select name="filter_type"><option value="gt" selected>&gt;</option><option value="lt">&lt;</option><option value="between">\u5728\u533a\u95f4</option></select><input type="text" name="filterValue"><span class="filter_between_span" style="display:none;"><input type="text" name="filterValueStart" style="margin-right: 5px;">\u81f3<input type="text" name="filterValueEnd" style="margin-left: 5px;"></span> \u7684\u5143\u7d20</p>', p += "</div>", p += '<div style="height: 47px; overflow: hidden; padding: 10px 15px; box-sizing: border-box;">', p += '<div class="sa-sdk-heatmap-filterflyout-submitbtn" style="display: inline-block; float: right; width:56px; height:28px; background:rgba(4,203,148,1); border-radius:3px; font-size:13px; font-family:PingFangSC-Medium,PingFang SC; font-weight:500; color:rgba(255,255,255,1); text-align: center; line-height: 28px; cursor: pointer;">\u786e\u5b9a</div><a class="sa-sdk-heatmap-filterflyout-cancelbtn" href="#" style="float: right; display: inline-block; line-height: 28px; margin-right: 6px; font-size:13px; font-family:PingFangSC-Regular,PingFang SC; font-weight:400; color:rgba(71,86,105,1); text-decoration: none;">\u53d6\u6d88</a>', p += "</div>", p += "</form></div>", t(u).on("click", "#sa_sdk_heatmap_toolbar_filter", function (e) {
          ...
          if ("between" === e) {
            if (!o(r.val())) return void l.showErrorInfo(2, {
              error: s
            });
            if (!o(i.val())) return void l.showErrorInfo(2, {
              error: s
            });
            if (Number(r.val()) > Number(i.val())) return void l.showErrorInfo(2, {
              error: u
            });
            a(e, r.val(), i.val())
          } else {
            if (!o(n.val())) return void l.showErrorInfo(2, {
              error: s
            });
            a(e, n.val())
          }
      ...
      calculateHeatData: function (e) {
        ...
        if (!e.page_view || 0 === Number(e.page_view)) return i.showErrorInfo(2, {
          error: "\u70b9\u51fb\u7387\u8ba1\u7b97\u5931\u8d25\uff0c\u6ca1\u6709\u5f00\u542fautoTrack!"
        }), !1;
        var o = parseInt(e.page_view, 10),
          a = e.heat_map_id;
        e = e.rows;
        var s = 0,
          l = [],
      ...
      heatData: function (e) {
        for (var t = [.005, .01, .025, .05, .1, .5], n = 0; n < t.length; n++)
          if (e < t[n]) return n;
        return 6
      },
      ...
      showEffectBox: function (e, t, n) {
        if ("fixslidedown" === this.is_fix_state) t.style.position = "fixed", t.style.left = "auto", t.style.right = 0, t.style.top = 0, n && (t.className = "sa-heat-box-effect-2017314");
      ...
      bindEffect: function () {
        function e(e) {
          var i = e.currentTarget,
            a = (i.getAttribute("data-heat-place"), t(i).data("clickdata"));
          if (!a) return !1;
    ...
    o = {
      ...
      prepare: function (e, t, o) {
        ...
        n.errorMsg && i.showErrorInfo(2, {
          error: n.errorMsg
        });
        var l = n.para.web_url || null;
        return r.sessionStorage.isSupport() && sessionStorage.getItem && sessionStorage.getItem("sensors_heatmap_url") && (l = sessionStorage.getItem("sensors_heatmap_url") || null), i.setCssStyle(), l ? (n.para.web_url = l, sessionStorage.setItem("sensors_heatmap_url", l), a(), void 0) : (i.showErrorInfo(2, {
          error: "\u83b7\u53d6web_url\u8d85\u65f6"
        }), !1)
      }
    };
  window.sa_jssdk_heatmap_render = function (e, t, i, a) {
    n = e, n.heatmap_version = "1.15.12", r = n._, r.bindReady = function (e, t) {
      t = t || window;
      var r = !1,
        i = !0,
        o = t.document,
        ...
        l = s ? "addEventListener" : "attachEvent",
        u = s ? "removeEventListener" : "detachEvent",
        c = s ? "" : "on",
        d = function (n) {
