  ...
  try {
    ...
    "object" != typeof JSON && (JSON = {}),
      ...
      function () {
        ...
        sd._t = sd._t || 1 * new Date, sd.lib_version = "1.15.12", sd.is_first_visitor = !1, sd.source_channel_standard = "utm_source utm_medium utm_campaign utm_content utm_term"
      }, sd.log = function () {
      ...
      saNewUser = {
        ...
        setDeviceId: function (e) {
          var t = null,
            ...
            s = {};
          null != r && _.isJSONString(r) && (s = JSON.parse(r), s.$device_id && (t = s.$device_id)), t = t || e, sd.para.cross_subdomain === !0 ? store.set("$device_id", t) : (s.$device_id = t,
            _.cookie.set("sensorsdata2015jssdkcross", JSON.stringify(s), null, !0)), sd.para.is_track_device_id && (_.info.currentProps.$device_id = t)
        },
    ...
    if (_.each(methods, function (e) {
      ...
      }), "string" != typeof window.csiiSDK202007) return "undefined" == typeof window.csiiSDK202007 ? (window.csiiSDK202007 = sd, sd) : window.csiiSDK202007;
    sd.setPreConfig(window[csiiSDK202007]), window[csiiSDK202007] = sd, window.csiiSDK202007 = sd, sd.init()
  } catch (err) {
